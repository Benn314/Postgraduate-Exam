...
![](asset/Pasted%20image%2020231215203031.png)这道题综合一点，先运用了定积分的换元消除未知常量 x（积分中 x 属于常量，求导中 x 才属于变量）（同时改变了上下限，这点注意）然后运用洛必达法则进行化简，化简结果结合题意可构造求导的基本公式，直接代入已知量求出最终结果，很不错的题目
...
- [ ] 结合讲义收集定积分的特殊性质做成 Anki 卡片 📅 2023-12-19 
