...
反例论证：
![](asset/Pasted%20image%2020231128152922.png) ![](asset/Pasted%20image%2020231128153224.png)
...
![](asset/Pasted%20image%2020231128154145.png)

- [ ] 📅 2023-11-29 罗尔定理的证明要会写（考试是有可能出现的）同时记录到 anki 卡片中，方便回顾
...
- [ ] 高阶无穷小的几道公式让奕迅重新拿给你看，然后制作成 anki 卡片📅 2023-11-29 

![](asset/Pasted%20image%2020231128211636.png)
![](asset/Pasted%20image%2020231128212041.png)

Pn(x)中好像懂了，每一项都是由导数×dx（也就是 dy），n 阶导就是 $f^{n}(x_0)×dx^n$ 所以是$（x-x_0）^n$ 然后每一项求导，系数会累计乘（变成 n 的阶乘），需要乘对应分母进行约分（**但到了这，我又有了疑惑，为什么要约分呢？这不是求导的结果吗？**）

- [ ] 这里加粗疑惑问一下奕迅 📅 2023-11-29 
