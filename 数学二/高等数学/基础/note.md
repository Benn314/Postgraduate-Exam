...
- [x] 做一下不定式的anki卡片（7种），方便复习（例如 0/0的三种情况） ➕ 2023-11-24 📅 2023-11-26 ✅ 2023-12-28
...
> 有根号一般很可能与无理数挂钩，如果我们用第一类积分法解决不了则用第二类
...
![](asset/Pasted%20image%2020231208102653.png)说成多项式的最高阶数比较好理解
...
![](asset/Pasted%20image%2020231208154800.png)
...
![](asset/Pasted%20image%2020231215104432.png)积分中值定理的推广是基于拉格朗日中值定理来的
...
$I_1$ 求的是 0 到 π/2 的面积（sinx 和 cosx 面积都相同）
...
![](asset/Pasted%20image%2020231216103940.png)

判别法![](asset/Pasted%20image%2020231216104320.png)

基于上面判别法，α等于 3/2 ，我们这里为什么要乘以 $x^{\frac{3}{2}}$？因为分子分母相差 3/2 倍，同阶来抓大放小容易判断
![](asset/Pasted%20image%2020231216104801.png)

#### 伽马函数

![](asset/Pasted%20image%2020231216105309.png)伽马函数除了幂函数部分，其他部分都不能动

![](asset/Pasted%20image%2020231216110619.png)上图举了两个例子，而不是只有一个![](asset/Pasted%20image%2020231216110926.png)

![](asset/Pasted%20image%2020231216111526.png)

数学哲学：无限是有限的延伸，所以研究无穷的区间我们可以先研究有限的情况再进行推广
![](asset/Pasted%20image%2020231216111856.png)

![](asset/Pasted%20image%2020231216112251.png) ![](asset/Pasted%20image%2020231216112423.png)条件跟右侧的判别法一模一样

![](asset/Pasted%20image%2020231216112654.png) ![](asset/Pasted%20image%2020231216112716.png)

> 注：对称性和奇偶性仅适用于有限区间，无限区间不一定对（没说无限区间不能用，只是不能随便用）
...
之所以加 ε，是因为 a 是瑕点，加了 ε 后就从反常积分变成正常积分计算了
...
![](asset/Pasted%20image%2020231216163051.png)趋于无穷则是对于区间的判别，趋于某一具体值则是对于点的判别![](asset/Pasted%20image%2020231216163201.png)
